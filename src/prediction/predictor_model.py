...
from darts.models.forecasting.tbats_model import BATS
...
class Forecaster:
    """A wrapper class for the BATS Forecaster.

    This class provides a consistent interface that can be used with other
    Forecaster models.
    """

    model_name = "BATS Forecaster"
    ...
    def __init__(
        ...
        """Construct a new BATS Forecaster
        ...
        Args:
            ...
            seasonal_periods (Union[str, List, None]): Length of each of the periods (amount of observations in each period).
                TBATS accepts int and float values here. BATS accepts only int values.
            ...
            use_arma_errors (Optional[bool]): When True BATS will try to improve the model by modelling residuals with ARMA.
            ...
            n_jobs (Optional[int]): How many jobs to run in parallel when fitting BATS model.
    ...
    def fit(
        ...
        A separate BATS model is fit to each series that is contained
        in the data.
    ...
    def _fit_on_series(self, history: pd.DataFrame, data_schema: ForecastingSchema):
        """Fit BATS model to given individual series of data"""
        model = BATS(
