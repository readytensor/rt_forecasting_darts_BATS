...
def map_hyperparameters(hyperparameters_dict: dict):
    ...
    if (
        "box_cox_lower_bound" in hyperparameters_dict
        and "box_cox_upper_bound" in hyperparameters_dict
    ):
        lower = hyperparameters_dict["box_cox_lower_bound"]
        upper = hyperparameters_dict["box_cox_upper_bound"]
        hyperparameters_dict["box_cox_bounds"] = (lower, upper)
        hyperparameters_dict.pop("box_cox_lower_bound")
        hyperparameters_dict.pop("box_cox_upper_bound")

    elif (
        "box_cox_lower_bound" in hyperparameters_dict
        or "box_cox_upper_bound" in hyperparameters_dict
    ):
        raise ValueError("Both bounds of box-cox have to be set.")
